...
# Projeto "Bluemers Library"

# Trata-se de um site para catalogar um acervo de livros sobre tecnologia da informação e disponibilizar o link para acesso a um site e fazer a compra, assim como informações sobre a editora, número de páginas, autor e a imagem do livro. 
...
# Modelar a Classe Livros -> tabela Livros
class Livros(db.Model):
    ...
    imagem_url = db.Column(db.String(1000), nullable=False)
    menor_preço = db.Column(db.String(1000), nullable=False)
    ...
    def read_single(id_registro):
        # SELECT * FROM Livros WHERE id = X, on X é o valor do id na coluna id da tabela Livros
    ...
    def update(self, nova_editora, novo_titulo, novo_autor, novo_numero_paginas, nova_imagem_url, novo_menor_preço): # função que atualiza os valores de nome e imagem_url
...
def index():
    ...
    return render_template("index.html", total=total, registros=registros)
